...
const { TelegraPh, UploadFileUgu, webp2mp4File, floNime } = require('../lib/hyperupload');
...
const { smsg, runtime, fetchUrl, isUrl, processTime, formatp, tanggal, formatDate, getTime,  sleep, generateProfilePicture, clockString, fetchJson, getBuffer, jsonformat, format, parseMention, getRandom } = require('../lib/hyperfunc');
...
//========================================================================================================================//
//========================================================================================================================//	  
    const jay = (m.quoted || m); 
    const quoted = (jay.mtype == 'buttonsMessage') ? jay[Object.keys(jay)[1]] : (jay.mtype == 'templateMessage') ? jay.hydratedTemplate[Object.keys(jay.hydratedTemplate)[1]] : (jay.mtype == 'product') ? jay[Object.keys(jay)[0]] : m.quoted ? m.quoted : m; 
...
async function handleMessageRevocation(client, revocationMessage) {
  ...
  if (originalMessage) {
    ...
    let notificationText = `░𝗛𝗬𝗣𝗘𝗥 𝗔𝗡𝗧𝗜𝗗𝗘𝗟𝗘𝗧𝗘 𝗥𝗘𝗣𝗢𝗥𝗧░\n\n` +
...
if (antilinkall === 'on' && body.includes('https://') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`𝗛𝗲𝘆 @${ki.split("@")[0]}👋\n\n𝗦𝗲𝗻𝗱𝗶𝗻𝗴 𝗟𝗶𝗻𝗸𝘀 𝗶𝘀 𝗣𝗿𝗼𝗵𝗶𝗯𝗶𝘁𝗲𝗱 𝗶𝗻 𝘁𝗵𝗶𝘀 𝗚𝗿𝗼𝘂𝗽 !`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
  ...
  //========================================================================================================================//
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ HYPER-BOT ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./Media/Hyper.jpg'),
                                sourceUrl: 'https://wa.me/254794597254?text=Hello+Hyper+dev+I+need+a+bot',
                                mediaType: 1,
...
//========================================================================================================================//	
case "pair": case "rent": {
if (!q) return await reply("Please provide valid Whatsapp number  Example- pair 25479459XXX");
...
//========================================================================================================================//		      
 ...
 await client.sendMessage(
        m.chat,
        {
          ...
          mimetype: "video/mp4",
          caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗛𝗬𝗣𝗘𝗥-𝗕𝗢𝗧",
        },
        { quoted: m }
      );
      return;
        ...
        async function redeployApp() {
            try {
                const response = await axios.post(
                    ...
                    {
                        source_blob: {
                            url: "https://github.com/sir-jay0001/HYPER-BOT/tarball/main",
                        },
                    },
                    {
                        headers: {
                ...
                await m.reply("Your bot is undergoing a ruthless upgrade, hold tight for the next 2 minutes as the redeploy executes! Once done, you’ll have the freshest version of *HYPER-BOT* unleashed upon you.");
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY HYPER-BOT`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
...
//========================================================================================================================//		      
	      case 'typography': {   
		          if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Typography Jay");
      return;
    }
     try {
...
//========================================================================================================================//		      
	      case 'purple': {		 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "purple Jay");
      return;
    }
     try {
...
//========================================================================================================================//		      
	      case 'thunder':{		       
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Thunder Jay");
      return;
    }
	try {
...
//========================================================================================================================//		      
	case 'leaves': {		     
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Leaves HYPER-BOT");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case '1917': {		      
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "1917 Jay");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'arena': {		      
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "arena HYPER-BOT");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'hacker': {		      
		      if (!text || text == "") {
    m.reply("Example usage :  " + prefix + "hacker Jay");
    return;
  }
  try {
...
//========================================================================================================================//		      
	      case 'sand': {	 
		      if (!text || text == "") {
    m.reply("Example Usage : " + prefix + "sand Hyper");
    return;
  }
  try {
...
//========================================================================================================================//		      
	      case 'dragonball': {		      
    if (!text || text == "") {
      m.reply("Example usage :  " + prefix + "dragonball Jay");
      return;
    }
      try {
...
//========================================================================================================================//		      
	      case 'naruto': {		      
		      if (!text || text == "") {
      m.reply("Example usage : " + prefix + "naruto Jay0001");
      return;
    }
    try {
...
//========================================================================================================================//		      
	      case 'graffiti': {		      
		      if (!text || text == "") {
    m.reply("Example usage : " + prefix + "graffiti Jay");
    return;
  }
  try {
...
//========================================================================================================================//		      
	      case 'cat': {		   
		  if (!text || text == "") { m.reply("Example usage : * " + prefix + "cat Jay");
    return;
  }
  try {
...
//========================================================================================================================//		      
		      case 'child': {	    		     
		      if (!text || text == "") {
    m.reply("Example usage: " + prefix + "Child Hyper");
    return;
  } 
  try {
...
try {
        ...
        await client.sendMessage(from, { image: { url: data.url }, caption: '*GENERATED BY HYPER MD*' }, { quoted: m });
    } catch (e) {
        console.log(e);
...
if (!m.isGroup) throw group;	      
    ...
    if (!args || !args[0]) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝗛𝘆𝗽𝗲𝗿 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 ${_0x2f8982.length} 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
//========================================================================================================================//		      
  ...
  try {
    ...
    if (!text) {
      return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗛𝗬𝗣𝗘𝗥 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    }
...
if (!text) return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 Hyper AI 𝗨𝘀𝗲 𝗚𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
if (!/image|pdf/.test(mime)) return m.reply("That is not an image, try again while quoting an actual image.");             
                    ...
                    m.reply(`𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗛𝘆𝗽𝗲𝗿[𝗛𝗬𝗣𝗘𝗥-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 ${mime.includes("pdf") ? "𝗣𝗗𝗙" : "𝗜𝗺𝗮𝗴𝗲"} . . .`);
...
//========================================================================================================================//		      
	      case "vision": {
		      if (!msgR || !text) {
    m.reply("𝗤𝘂𝗼𝘁𝗲 𝗮𝗻 𝗶𝗺𝗮𝗴𝗲 𝗮𝗻𝗱 𝗴𝗶𝘃𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵. 𝗜'𝗺 𝗛𝗬𝗣𝗘𝗥 𝗔𝗶, 𝗶 𝘂𝘀𝗲 𝗕𝗮𝗿𝗱 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘇𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    return;
  }
  ;
  let _0x44b3e0;
...
//========================================================================================================================//		      
			...
			client.sendMessage(m.chat, { image: proses, caption: '𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 𝗯𝘆 𝗛𝘆𝗽𝗲𝗿-𝗕𝗼𝘁'}, { quoted: m })
			}
			break;
...
case "kill": case "kickall": {
	  if (!m.isGroup) throw group;
          ...
          let hyper = participants.filter(_0x5202af => _0x5202af.id != client.decodeJid(client.user.id)).map(_0x3c0c18 => _0x3c0c18.id);
      ...
      await client.groupUpdateDescription(m.chat, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝗛𝘆𝗽𝗲𝗿 𝗗𝗲𝘃 !");
...
//========================================================================================================================//		      
    ...
    try {
      ...
      await client.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 𝗛𝘆𝗽𝗲𝗿 𝗗𝗲𝘃 !");
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
let fta = await uploadToCatbox(fdr)
                    m.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗛𝘆𝗽𝗲𝗿 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
...
let xf = m.quoted.text;
                ...
                const {
                    quote
                } = require('./lib/hyperquotely.js')
                
                let pppuser = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/0d4f06d19062a2ce8cafd.jpg')
...
//========================================================================================================================//		      
  case "system": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/vev67n.jpg' }, caption:`*𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: 𝗛𝗬𝗣𝗘𝗥-𝗕𝗢𝗧*\n\n*𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒*\n\n*𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}*\n\n*𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: 𝗛𝗲𝗿𝗼𝗸𝘂*\n\n*𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: 𝗛𝘆𝗽𝗲𝗿*\n\n*𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys*\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: 𝗦𝗶𝗿 𝗷𝗮𝘆༆`}); 
 break;
...
await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗛𝘆𝗽𝗲𝗿 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 '+gcdata.participants.length+' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
...
case "faker": {
    ...
    if (!args || !args[0]) {
      ...
      let _0x2d7d67 = `𝗛𝘆𝗽𝗲𝗿 𝚑𝚊𝚜 𝚍𝚎𝚝𝚎𝚌𝚝𝚎𝚍 𝚝𝚑𝚎 𝚏𝚘𝚕𝚕𝚘𝚠𝚒𝚗𝚐 ${_0x2f8982.length} 𝙵𝚊𝚔𝚎 𝚊𝚌𝚌𝚘𝚞𝚗𝚝𝚜 𝚒𝚗 𝚝𝚑𝚒𝚜 𝚐𝚛𝚘𝚞𝚙:- \n`;
      for (let _0x28761c of _0x2f8982) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝙽𝚘𝚠 𝗛𝘆𝗽𝗲𝗿 𝚠𝚒𝚕𝚕 𝚛𝚎𝚖𝚘𝚟𝚎 ${_0x2f8982.length} 𝙵𝚊𝚔𝚎 𝙰𝚌𝚌𝚘𝚞𝚗𝚝𝚜 𝚏𝚛𝚘𝚖 𝚝𝚑𝚒𝚜 𝚐𝚛𝚘𝚞𝚙.\n\n𝙶𝚘𝚘𝚍𝚋𝚢𝚎👋 𝙵𝚊𝚔𝚎 𝚙𝚎𝚘𝚙𝚕𝚎.`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
//========================================================================================================================//		      
 ...
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝗛𝗬𝗣𝗘𝗥-𝗠𝗗:*\n\n';  
...
if (users == "254794597254@s.whatsapp.net") return m.reply("It's an Owner Number! 😡");
...
try {
        ...
        const capp = `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗛𝗬𝗣𝗘𝗥-𝗕𝗢𝗧`;
...
//========================================================================================================================//		      
 ...
 client.sendMessage(m.chat, { image: { url: `https://telegra.ph/file/0d4f06d19062a2ce8cafd.jpg` }, caption: ` Hello👋 *${pushname}*, 𝗕𝗲𝗹𝗼𝘄 𝗶𝘀 𝗛𝗬𝗣𝗘𝗥-𝗕𝗢𝗧 𝗴𝗶𝘁𝗵𝘂𝗯 𝗿𝗲𝗽𝗼𓅂\n\nFork and maybe give us a star🌟.\n\n https://github.com/sir-jay0001/HYPER-BOT\n\nLink with your whatsapp using pairing link below\n\nhttps://hyper-session.onrender.com/\n\nCopy the session and paste it on the SESSION string, Fill in the other required Variables before Deploy\n\nEnjoy and have fun with the Bot\n\n𝗠𝗮𝗱𝗲 𝗼𝗻 𝗲𝗮𝗿𝘁𝗵 𝗯𝘆 𝗦𝗶𝗿 𝗷𝗮𝘆00011 !`},{quoted : m });
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝗛𝘆𝗽𝗲𝗿-𝗔𝗶 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
if (!m.quoted) return m.reply("Hurrahhh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(client.user.id, { image: { url: imageUrl }, caption: `Retrieved by Hyper!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(client.user.id, { video: { url: videoUrl }, caption: `Retrieved by Hyper!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
                ...
                client.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: '𝗛𝗬𝗣𝗘𝗥-𝗕𝗢𝗧',
                            body: 'https://github.com/sir-jay0001/HYPER-BOT',
                            thumbnailUrl: 'https://files.catbox.moe/vev67n.jpg',
                            sourceUrl: 'https://github.com/sir-jay0001/HYPER-BOT',
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    }
...
//========================================================================================================================//		      
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝗛𝘆𝗽𝗲𝗿-𝗕𝗼𝘁`}, { quoted: m }) 
...
case "block": { 
 ...
 let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
	 if (users == "254794597254@s.whatsapp.net") return m.reply("𝗜 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗹𝗼𝗰𝗸 𝗺𝘆 𝗢𝘄𝗻𝗲𝗿 😡");
...
try {
        ...
        pp = 'https://files.catbox.moe/vev67n.jpg';
      }
        ...
        default: {
          if (cmd && budy.toLowerCase() != undefined) {
            ...
            if (argsLog || (cmd && !m.isGroup)) {
              ...
              console.log(chalk.black(chalk.bgRed("[ ERROR ]")), color("command", "turquoise"), color(`${prefix}${command}`, "turquoise"), color("Hyper", "turquoise"));
